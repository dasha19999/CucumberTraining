...
Scenario: Adding Employees Experience
    ...
    And user select date\ month {Jan}, year {2018}, day {01} date( month "Jan", year "2018", day "01")
    When user clicks To text box and Calender is displayed
    And user select date\ month {Sep}, year {2022}, day {30} date( month "Sep", year "2022", day "30")
